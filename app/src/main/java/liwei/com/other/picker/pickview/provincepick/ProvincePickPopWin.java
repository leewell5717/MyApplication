...
import liwei.com.other.picker.pickview.view.PickerView;
...
public class ProvincePickPopWin extends PopupWindow implements OnClickListener, PickerView.OnPickedListener {
	...
	private void init() {
		...
		provincePickerV = (PickerView) contentView.findViewById(R.id.picker_province);
		cityPickerV = (PickerView) contentView.findViewById(R.id.picker_city);
		pickerContainerV = contentView.findViewById(R.id.container_picker);
		contentView.findViewById(R.id.picker_county).setVisibility(View.GONE);
	...
	private void initPickerViews(String provinceId, String cityId) {
		if (!isProvinceInit || !mProvinceId.equals(provinceId)) {
			...
			List<PickerItem> provinceItemList = new ArrayList<>();
	...
	private void initCityPickerView(ProvinceModel provinceModel, String cityId) {
		...
		CityModel cityModel;
		List<PickerItem> cityItemList = new ArrayList<>();
		for (int i = 0; i < count; i++) {
