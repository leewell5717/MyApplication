package liwei.com.other.picker.pickview.view;
...
public class PickerView extends View {
    ...
    /**
     * 绘制非选中的item
     * @param position 距离curSelectedPos的差值
     * @param type     1表示向下绘制，-1表示向上绘制
     */
    private void drawOtherText(Canvas canvas, int position, int type) {
        float d = MARGIN_ALPHA * minTxtSize * position + type * moveDistance;
        ...
        canvas.drawText(formatText(text, size), (float) (width / 2.0), baseline, mPaint);
    }
