    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray a = mContext.obtainStyledAttributes(attrs,
                    R.styleable.MaterialMenuGroup);

            groupCategory = a.getInt(R.styleable.MaterialMenuGroup_android_menuCategory, defaultItemCategory);
            groupOrder = a.getInt(R.styleable.MaterialMenuGroup_android_orderInCategory, defaultItemOrder);
        ...
        public void readItem(AttributeSet attrs) {
            TypedArray a = mContext.getApplicationContext().obtainStyledAttributes(attrs,
                    R.styleable.MaterialIconViewFormat);

            // Inherit attributes from the group as default value
            itemIconResId = a.getInt(R.styleable.MaterialIconViewFormat_materialIcon, -1);
            itemIconColor = a.getColor(R.styleable.MaterialIconViewFormat_materialIconColor, -1);

            a.recycle();

            a = mContext.obtainStyledAttributes(attrs, R.styleable.MaterialMenuItem);

            final int category = a.getInt(R.styleable.MaterialMenuGroup_android_menuCategory, groupCategory);
            final int order = a.getInt(R.styleable.MaterialMenuGroup_android_orderInCategory, groupOrder);
