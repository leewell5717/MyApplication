package liwei.com.other.ExpandableTextview.view;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        grarity = typedArray.getInt(R.styleable.ExpandableTextView_collapseExpandGrarity, Gravity.START);
        drawableGrarity=typedArray.getInt(R.styleable.ExpandableTextView_drawableGrarity, Gravity.END);
    ...
    private void findViews() {
        ...
        inflater.inflate(R.layout.expand_collapse_container, this);
...
//            mTvContent.setMaxLines(mMaxCollapsedLines);
    ...
    public interface OnExpandStateChangeListener {
        /**
         * @param textView  要展开/折叠的TextView
         * @param isExpanded  TextView是否已展开
         */
