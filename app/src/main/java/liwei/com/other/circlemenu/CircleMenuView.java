...
public class CircleMenuView extends FrameLayout implements View.OnClickListener {
    ...
    public CircleMenuView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        try {
            ...
            mIconMenu = a.getResourceId(R.styleable.CircleMenuView_icon_menu, R.mipmap.ic_menu_black_24dp);
            mIconClose = a.getResourceId(R.styleable.CircleMenuView_icon_close, R.mipmap.ic_close_black_24dp);
    ...
    public CircleMenuView(@NonNull Context context, @NonNull List<Integer> icons, @NonNull List<Integer> colors) {
        ...
        mIconMenu = R.mipmap.ic_menu_black_24dp;
        mIconClose = R.mipmap.ic_close_black_24dp;
    ...
    private void initLayout(@NonNull Context context) {
        LayoutInflater.from(context).inflate(R.layout.layout_circle_menu, this, true);
