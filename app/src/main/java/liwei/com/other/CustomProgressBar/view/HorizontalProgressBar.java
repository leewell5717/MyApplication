package liwei.com.other.CustomProgressBar.view;
...
public class HorizontalProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawLine(getPaddingLeft(), tipHeight + progressMarginTop, getWidth(),
                tipHeight + progressMarginTop, bgPaint);
        canvas.drawLine(getPaddingLeft(), tipHeight + progressMarginTop, currentProgress,
                tipHeight + progressMarginTop, progressPaint);
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (progressListener != null) {
                    //TODO liwei注释原因：如果不格式化value，小数位数会不定
//                    progressListener.currentProgressListener(value);
                    progressListener.currentProgressListener(formatNumTwo(value));
                }
     ...
     * 格式化数字(保留两位小数)
     */
    public static float formatNumTwo(float originNum) {
